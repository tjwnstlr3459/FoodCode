...
public class InputUtils {
	...
	public void setRegPatternInt(String regPatternInt) {
		this.regPatternInt = regPatternInt;
	}
	public String getRegPatternInt() {
		return regPatternInt;
	}
	...
	public boolean inputWhoIntegerCheck(String inputValue) {
		...
		resultMatch = Pattern.matches(regPatternInt, inputValue);
