...
import kr.jangboo.minhyeong.model.service.Number25Service;
import kr.jangboo.minhyeong.util.PrintUtils;
import kr.jangboo.minhyeong.view.Number25View;
...
public class Number25Controller {
	...
	public static void main(String args[]) {
		...
		//4. 비지니스 로직
		pellNumberList = srvc.insertPellNumberToList(pellNumberList, length);
		// 결과
