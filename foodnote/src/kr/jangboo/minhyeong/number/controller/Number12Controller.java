...
import kr.jangboo.minhyeong.number.model.service.Number12Service;
import kr.jangboo.minhyeong.number.view.Number12View;
...
public class Number12Controller {
	...
	public static void main(String args[]) {
		...
		try {
			...
			//패턴이 일치하지 않는 경우 > 숫자만 포함되지 않는 값
			if(resultPattern == false) {	// ! 기호를 사용할 수 있지만 명시적으로 == false를 사용하자.
