...
import kr.jangboo.minhyeong.number.model.service.Number7Service;
import kr.jangboo.minhyeong.number.view.Number7View;
...
public class Number7Controller {
	...
	public static void main(String args[]) {
		...
		lucasSequence = srvc.insertLucasSequenceToList(length);
